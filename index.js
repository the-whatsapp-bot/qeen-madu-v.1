...
if(!configss.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = configss.SESSION_ID.split('MADU-MD~')[1];
...
let up = `Qᴇᴇɴ ᴍᴀᴅᴜ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇꜱꜱꜰᴜʟ \n\nPREFIX:\n\nchannell-https://whatsapp.com/channel/0029Vb2th7xChq6PmU8iGF1B`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/S4kz18cV/Rashmika-Ofc.jpg` }, caption: up })
if (config.AUTO_NEWS === true) {
  const { startNewsService } = require("./lib/news");
